    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Link to="/docking" className="block h-full">
          <Card title="Docking Bay Diagnostics" subtitle="Traffic Control & Bay Status" className="h-full hover:border-cyan-500/50 hover:bg-space-900/60 transition-all">
        ...
        <Link to="/power" className="block h-full">
          <Card title="Power Grid Analysis" subtitle="Reactor Output & Distribution" className="h-full hover:border-cyan-500/50 hover:bg-space-900/60 transition-all">
             <div className="space-y-6">
                <div>
        ...
        <Link to="/life-support" className="block h-full">
          <Card title="Life Support Matrix" subtitle="Environmental Controls" className="h-full hover:border-cyan-500/50 hover:bg-space-900/60 transition-all">
        ...
        <Link to="/inventory" className="block h-full">
          <Card title="Logistics & Supply" subtitle="Inventory Management" className="h-full hover:border-cyan-500/50 hover:bg-space-900/60 transition-all">
             <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
